...
| Item original | O que foi pedido | Estado | Onde vive a decisão |
|---|---|---|---|
| 4 | "inspirado em outros editores de mapas, a melhor referência é warcraft II, mas busque outros na web. WYSIWYG, salva em matriz x,y, pergunte a @GlintFx" | Parcial: a matriz x,y é o formato do GlintFx (lei L-03); o desenho WYSIWYG da tela espera o GlintFx ter janela (lei L-14, item 4). A pesquisa de outros editores foi feita em 21/08/2026 e cobriu Warcraft II (formato PUD), Warcraft III, Tiled, LDtk, Godot, Valve Hammer, Ogmo e RPG Maker; ela sustenta boa parte das L-13 e L-14 e do pedido de formato enviado ao GlintFx. | `GODS_LAWS.md` L-03 e L-14 |
