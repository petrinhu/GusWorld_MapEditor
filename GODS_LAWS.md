...
- **A ordem canônica de serialização.** O caminho de gravação está listado acima como lugar de risco, e está certo: escritor mais repartição convexa mais selo mais arquivo ao lado numa classe só é monolito. **Mas a ordem em que os blocos saem no arquivo NÃO é detalhe de implementação, é o contrato**: o GlintFx a fixou como normativa, e é ela que sustenta o portão de ida e volta byte a byte (`FMT-4`), que por sua vez é a prova mais forte que o formato tem. Um revisor que aplique a primeira pergunta ao escritor e conclua "isto tem razões demais para mudar, divida" pode quebrar essa ordem sem perceber. **Coesão exigida por contrato de terceiro não é monolito, e dividi-la não é conserto, é quebra.** **Cerca obrigatória, sem a qual esta fronteira vira porta dos fundos:** ela vale só quando o contrato é de terceiro, **verificável e citável** (a lei, a especificação publicada do formato, o portão de teste que ele sustenta), e **quem a invoca cita onde o contrato está**. *"Fica melhor junto"*, *"é mais legível assim"* e *"sempre foi uma coisa só"* **não são contrato**, e invocar a fronteira sem citar a fonte é o mesmo que não invocá-la. Cerca trazida pela sessão do `gusworld` em 24/08/2026: sem ela, "coesão exigida por contrato" vira a desculpa universal para não dividir nada, e a lei inteira perde o dente. Achado devolvido pela sessão do `gusworld` em 24/08/2026, ao adaptar esta lei para lá: sem freio escrito, a régua vira desculpa para fragmentar o que não devia.
